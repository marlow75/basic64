...
public class VIC2 {
	...
	private static int beam = 0, oldBeam = 0; // raster
	...
	public static boolean bad_line = false; // bad line marker
	public static int offset; // VIC bank

	private static int oy = -1, om = -1, och = -1, ocode = -1;
	private static int code, pen;
	
	// multicolor text
	private static boolean hiresChar = false, cc = false; // hires char in multicolor text mode - cc - color index calculated
	private static int ci = 0, cti = 0; // color index, color table index
